...
const Donor = (props) => {
  const { name, age, img, netWorth, otherAssets, donate, residence, founder } = props.donor
      ...
      <div className="col  ">
        <div className="card h-100 cart-details">
          ...
          <div className="card-body">
            ...
            <button onClick={() => props.countDonor(props.donor)} className="btn btn-color"> <i className="fas fa-hand-holding-usd icon"></i>Donate</button>
